...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="relative hover:cursor-pointer bg-white border border-gray-100 shadow-sm hover:shadow-md transition-colors duration-150 overflow-hidden flex flex-col h-full">
      {/* image */}
